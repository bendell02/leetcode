...
https://leetcode-cn.com/problems/basic-calculator-iv/solution/basic-calculator-iv-by-leetcode/

```
Runtime: 20 ms, faster than 16.95% of C++ online submissions for Basic Calculator IV.
Memory Usage: 18.9 MB, less than 16.95% of C++ online submissions for Basic Calculator IV.
```
